    ...
    recommendations?.length && recommendations?.map(recom => {
        ...
        <div class="list-div">
            ...
            <div class="content-div">
                ...
                <a id="view-detail-btn" class="primary-link" href="#" dot-id=${recom?.DOT?.ID}  onclick="window.open(${`https://creatorapp.zoho.com/peter_bluewire/customer-portal/#Page:Recommendation_Engine_S?loginUserEmail=`+queryParams["loginUserEmail"]+`&&selectedDOTid=`+recom?.DOT?.ID+`&&selectedAttackVectorID=`+recom?.Reptile_Index_Theory_Attack_Vector?.ID}, "_parent")" vector-id=${recom?.Reptile_Index_Theory_Attack_Vector?.ID} >
                    View Detail 
