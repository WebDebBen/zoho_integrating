ZOHO.CREATOR.init().then(async function (data) {
    ...
    recommendations?.length && recommendations?.map(recom => {
        ...
        <div class="list-div">
            ...
            <div class="content-div">
                ...
                <a id="view-all-btn" class="primary-link" href="#" dot-id=${recom?.DOT?.ID} vector-id=${recom?.Reptile_Index_Theory_Attack_Vector?.ID} >
                    View Detail 
    ...
    `;
    const viewDetailBtn = document.querySelectorAll("*[id=view-all-btn]");
    ...
    const viewAllBtn = document.getElementById("view-detail-btn");
