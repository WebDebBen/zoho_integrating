    ...
    recommendations?.length && recommendations?.map(recom => {
        ...
        <div class="list-div">
            ...
            <div class="content-div">
                ...
                <a id="view-all-btn" class="primary-link" href=${`https://creatorapp.zoho.com/peter_bluewire/customer-portal/#Page:Recommendation_Engine_S?loginUserEmail=`+queryParams["loginUserEmail"]+`&&selectedDOTid=`+recom?.DOT?.ID+`&&selectedAttackVectorID=`+recom?.ID}>
                    View Detail 
        ...
        viewAllBtn?.addEventListener('click', () => {
            window.open(`https://creatorapp.zoho.com/peter_bluewire/customer-portal/#Page:Recommendation_Engine_S?loginUserEmail=`+queryParams["loginUserEmail"]+`&&selectedDOTid=`+recom?.DOT?.ID+`&&selectedAttackVectorID=`+recom?.ID, "_parent");
        });
