    ...
    contentDiv.innerHTML = `
        <div class="list-div">
            ...
            <div class="content-div">
                ...
                <p>Loremasdadasasd</p>
                <a class="btn btn-primary" href="#">View Detail <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-double-right" viewBox="0 0 16 16">
