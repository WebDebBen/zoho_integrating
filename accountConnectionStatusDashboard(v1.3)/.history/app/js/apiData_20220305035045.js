...
ZOHO.CREATOR.init().then(async function (data) {
    ...
    contentDiv.innerHTML = `
        ...
        <button id="view-detail" class="btn btn-outline-primary primary-btn">View Detail</button>
    `;
    vewDetailBtn.addEventListener('click', () => {
        ...
        window.open("https://creatorapp.zoho.com/peter_bluewire/customer-portal/#Page:Recommendation_Engine_S","_parent");
    });
